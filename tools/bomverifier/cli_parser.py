...
def parse_argumetns():
    ...
    parser.add_argument('-lcscRW', choices=['lcsc', 'mpn'], type=str, help='rewrite cells according to distributor data')
    parser.add_argument('-promelec', type=str, nargs='?', const='mpn', choices=['mpn'], help='search data from distributor (mpn only)')
    parser.add_argument('-elitan', nargs='?', const='mpn', choices=['mpn'], help='search data from distributor (mpn only)')
